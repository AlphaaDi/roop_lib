...
def parse_args() -> None:
    ...
    program.add_argument('--similar-face-distance', help='face distance used for recognition', dest='similar_face_distance', type=float, default=100)
    ...
    # Convert args to a dictionary and save to a file
    args_dict = vars(args)
